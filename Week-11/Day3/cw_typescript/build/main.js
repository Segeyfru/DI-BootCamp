...
const username2 = new StateObject(132);
username2.state = '2323';
console.log(username2.state);
const username3 = new StateObject(['st', 'wew']);
...
const postWithAuthor = updatePost(post1, { author: 'John' });
const updatePostAllData = (post, update) => {
    return Object.assign(Object.assign({}, post), update);
};
// console.log(updatePostAllData(postWithAuthor,{author:'Jack'}));
// ReadOnly
const readOnlyPOst = Object.assign(Object.assign({}, post1), { author: 'jack' });
const adminName = 'undefined';
// Returt type
const createUser = (name, age, isTrue) => {
    return { name, age };
};
const newUser = createUser('Jane', 30, true);
const userParams1 = ['Jack', 20, true];
// const newnewUser
// const sum =(a,b)=>{
//     return a+b
// }
